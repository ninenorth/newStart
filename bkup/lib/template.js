    ...
    return `
      ...
      <body>
          ...
          <ul id="list-1" class="sortable">
           ...
           <button name="reorderList" id="sbtn-1" type="submit" form="reorder" formaction="/reorder" formmethod="POST" >Reorder</button>
           </form>
           </div>
           ...
           <ul id="list-2" class="sortable">
            ...
            <form id="reorder" action="/reorder" method="POST">
            <button name="reorderList" id="sbtn-2" type="submit" form="reorder" formaction="/reorder" formmethod="POST" >Reorder</button>
            </form>
            </div>
